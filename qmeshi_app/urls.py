...
#    path('items/<int:item_id>/impressions', views.ImpressionList.as_view(), name='impression_list'), # 感想一覧
#    path('items/<int:item_id>/impressions/new', views.ImpressionAdd.as_view(), name='impression_add'), # 感想登録
]